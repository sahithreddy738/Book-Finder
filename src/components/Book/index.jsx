...
const Book = ({ bookDetails }) => {
  ...
  return (
    <div
      className="w-[40%] h-[20%] md:w-[20%] md:h-[10%] flex flex-col gap-2 hover:bg-gray-300 p-4 rounded-lg hover:cursor-pointer"
      onClick={bookHandler}
    ...
    >
      <div className="w-full h-[90%]">
        <img
          src={
            cover_i ? COVERS_ID_URL + cover_i + "-L.jpg" : COVER_NOT_AVAILABLE
          }
          alt="cover-image"
